...
- For TRIVIAL changes, the Adaptation Strategy can be a single line ("Clean apply expected, no adaptation needed"). For STANDARD/COMPLEX, use per-file detail.
...
### Adaptation Strategy
[For STANDARD/COMPLEX: detailed per-file approach]
