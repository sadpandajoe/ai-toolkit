...
Use `rules/gates.md`'s Gate block after producing this output to decide whether to proceed automatically. The calling workflow may also use this output for a complexity gate evaluation.
