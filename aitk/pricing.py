...
PRICING = {
    # Claude 5 family (list prices, verified 2026-09-01 against the bundled
    # claude-api skill's shared/models.md). Fable 5.1 keeps Fable 5's base
    # rates but reads cache at 0.025x instead of 0.1x.
    "claude-fable-5-1": {
        "input": 10.00,
        "output": 50.00,
        "cache_read": 0.25,
