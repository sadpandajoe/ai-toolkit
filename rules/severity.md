...
Impact labels for plan and design review findings (`review/references/architecture.md`, `agents/codex/plan-validator.md`'s implementation-feasibility lens, etc.):
